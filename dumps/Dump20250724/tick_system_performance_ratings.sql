...
CREATE TABLE `performance_ratings` (
  ...
  CONSTRAINT `performance_ratings_ibfk_1` FOREIGN KEY (`executive_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `performance_ratings_ibfk_2` FOREIGN KEY (`manager_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  CONSTRAINT `performance_ratings_ibfk_3` FOREIGN KEY (`ticket_id`) REFERENCES `tickets` (`id`) ON DELETE CASCADE,
  CONSTRAINT `performance_ratings_chk_1` CHECK (((`rating` >= 1) and (`rating` <= 5)))
